        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <li class="{{ Request::is('home*') ? 'active' : '' }}">
                ...
                @if(Bouncer::can('Create_Insurercompany')) 

                  <li class="{{ Request::is('insurercompanies*') ? 'active' : '' }}">
                    <a href="{{url('insurercompanies')}}"><i class="fa fa-university" style="color:#1AB394"></i> <span class="nav-label">Insurer</span></a>
                </li>

                @endif

                 @if(Bouncer::can('Create_Product')) 

                  <li class="{{ Request::is('products*') ? 'active' : '' }}">
                    <a href="{{url('products')}}"><i class="fa fa-eye" style="color:#1AB394"></i> <span class="nav-label">Products</span></a>
                </li>

                @endif

               <!--   @if(Bouncer::can('Create_Client')) 

                  <li class="{{ Request::is('clients*') ? 'active' : '' }}">
                    <a href="{{url('clients')}}"><i class="fa fa-users" style="color:#1AB394"></i> <span class="nav-label">Clients</span></a>
                </li> -->

                @endif
                <!-- Clients Start -->
                <li class="nav-item @if(Request::is('clients*')
                                ||Request::is('closed-clients*')
                                ||Request::is('open-clients*')
                              ){{'active open selected'}};@endif">
                                @if(Bouncer::can('Create_Client')) 
                                <a href="{{ url('clients') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-users" style="color:#1AB394" aria-hidden="true"></i>
                ...
                <!-- Insurance Policies Start -->
                <li class="nav-item @if(Request::is('insurance_policies*')
                                ||Request::is('inactive-policies*')
                                ||Request::is('active-policies*')
                                ||Request::is('expired-policies*')
                              ){{'active open selected'}};@endif">
                                @if(Bouncer::can('Create_Insurance_policy')) 
                                <a href="{{ url('insurance_policies') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-bars" style="color:#1AB394" aria-hidden="true"></i>
                                    <span class="title">Insurance Policy</span>
                                     <span class="selected"></span>
               ...
               <!--  @if(Bouncer::can('Create_Insurance_policy')) 
                  ...
                  <li class="{{ Request::is('insurance_policies*') ? 'active' : '' }}">
                    <a href="{{url('insurance_policies')}}"><i class="fa fa-bars" style="color:#1AB394"></i> <span class="nav-label">Insurance Policy</span></a>
                </li>
                                    ...
                                    <ul class="nav metismenu">
                                        @if(Bouncer::can('Create_Role')) 
                                            ...
                                            <li class="{{ Request::is('roles*') ? 'active' : '' }}">
                                                <a href="{{url('roles')}}"><i class="fa fa-diamond"></i> <span class="nav-label">Roles</span></a>
                                            </li>
                ...
                @if(Bouncer::can('Create_User')) 
                 ...
                 ||Request::is('post-upload-countries*') || Request::is('statuses') || Request::is('paymentmodes')
                 || Request::is('policytypes') || Request::is('productcategories')
                        ...
                        <ul class="nav metismenu">
                             @if(Bouncer::can('Create_Country')) 
                                <li class="{{ Request::is('countries*') ? 'active' : '' }}">
                                    <a href="{{url('countries')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Countries</span></a>
                                </li>
                            ...
                            @if(Bouncer::can('Create_Status')) 
                                ...
                                <li class="{{ Request::is('statuses*') ? 'active' : '' }}">
                                    <a href="{{url('statuses')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Statuses</span></a>
                                </li>
                            ...
                            @endif
                             ...
                             @if(Bouncer::can('Create_Paymentmode')) 
                                        ...
                                        <li class="{{ Request::is('paymentmodes*') ? 'active' : '' }}">
                                            <a href="{{url('paymentmodes')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Payment Mode</span></a>
                                        </li>

                            @endif

                            @if(Bouncer::can('Create_Policytype')) 

                                        <li class="{{ Request::is('policytypes*') ? 'active' : '' }}">
                                            <a href="{{url('policytypes')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Policy Type</span></a>
                                        </li>

                            @endif

                            @if(Bouncer::can('Create_Productcategory')) 

                                        <li class="{{ Request::is('productcategories*') ? 'active' : '' }}">
                                            <a href="{{url('productcategories')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Product Category</span></a>
                                        </li>
                ...
                <!--   <li class="{{ Request::is('smses*') ? 'active' : '' }}">
                    <a href="{{url('smses')}}"><i class="fa fa-book" style="color:#1AB394"></i> <span class="nav-label">SMS</span></a>
                </li>
 -->
           ...
           <!--  <div class="pull-right">
            ...
            <div>
             ...
             <div class="page-footer-inner"> {{date('Y',time())}} &copy; &nbsp;{{ config('app.name', 'Laravel') }} &nbsp;|&nbsp;
                    <a href="#" target="_blank">FaithPod Tech</a>
            </div>
        </div>
