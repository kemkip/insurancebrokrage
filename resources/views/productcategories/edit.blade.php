    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <ul class="dropdown-menu dropdown-productcategory">
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($productcategory, ['method' => 'PATCH','route' => ['productcategories.update', $productcategory->id],'class'=>'form-horizontal']) !!}
